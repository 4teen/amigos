...
import static com.square.apps.amigos.Fragments.SearchCourseResultsFragment.CourseHolder.STUDENTS;
    ...
    private class FetchItemsTask extends AsyncTask<String, Void, List<Course>> {
        ...
        protected void onPostExecute(List<Course> courses) {
            for (Course c : courses) {
                ...
                map.put(USERS + "/" + user.getUid() + "/" + COURSES + "/" + courseCode, true);
                map.put(STUDENTS + "/" + courseCode + "/" + user.getUid(), true);
