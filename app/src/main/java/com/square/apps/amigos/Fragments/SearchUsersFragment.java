...
import static com.square.apps.amigos.Contract.EMAIL;
import static com.square.apps.amigos.Contract.GROUPS;
import static com.square.apps.amigos.Contract.GROUP_ID;
import static com.square.apps.amigos.Contract.MEMBERS;
...
public class SearchUsersFragment extends Fragment {
    ...
    public static class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        private void updateDatabase() {
            ...
            map.put(MEMBERS + "/" + groupID + "/" + userID, true);
            map.put(USERS + "/" + userID + "/" + GROUPS + "/" + groupID, true);
